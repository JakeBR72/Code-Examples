...
public final class ArraysAndReferences {
    ...
    private static NaturalNumber productOfArrayElements(NaturalNumber[] nnArray) {
        ...
        NaturalNumber[] tempArray = nnArray.clone();
        NaturalNumber productOfArrayElements = new NaturalNumber2(tempArray[0]);
        for (int i = 1; i < tempArray.length; i++) {
            productOfArrayElements.multiply(tempArray[i]);
        }
    ...
    public static void main(String[] args) {
         ...
         */
        NaturalNumber[] array = new NaturalNumber2[5];
