...
public final class StringReassembly {
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet, String str) {
        ...
        if (!subSetFound) {
            ...
            while (strSet.size() > 0) {
                String removed = strSet.removeAny();
    ...
    public static void main(String[] args) {
         ...
         * Get input file name
         */
        out.println("Input file (with fragments): ");
        String inputFileName = in.nextLine();
        SimpleReader inFile = new SimpleReader1L(inputFileName);
        //SimpleReader inFile = new SimpleReader1L("data/declaration-50-10.txt");
        /*
