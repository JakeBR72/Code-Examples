...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        temporary.data = x;
        temporary.next = this.lastLeft.next;
        temporary.previous = this.lastLeft;
        this.lastLeft.next.previous = temporary;
        this.lastLeft.next = temporary;
        this.rightLength++;
    ...
    public final T removeRightFront() {
        ...
        Node temporary = this.lastLeft.next;
        T x = temporary.data;
        this.lastLeft.next = temporary.next;
        temporary.next.previous = this.lastLeft;
        this.rightLength--;
        assert this.conventionHolds();
