...
public class BinarySearchTreeMethodsTest {
    ...
    public void test3Element() {
        ...
        BinaryTree<String> t2 = createBSTFromArgs("a", "b", "c");
        /*
         * Call method under test
         */
        boolean inTree = BinarySearchTreeMethods.isInTree(t1, "a");
    ...
    @Test
    public void removeSmallestFromBeginning() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("a", "b", "c");
    ...
    @Test
    public void removeSmallestFromMiddle() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("b", "a", "c");
    ...
    @Test
    public void removeSmallestFromEnd() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("b", "c", "a");
        BinaryTree<String> t2 = createBSTFromArgs("b", "c");
        /*
         * Call method under test
         */
