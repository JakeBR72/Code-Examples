...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <-5,-10> and s2 = <17>.
     */
    @Test
    public void test4() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-5, -10);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-5, -10);
        Sequence<Integer> seq2 = this.createFromArgs(17);
    ...
    public void test8() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-1073741824, 1073741825);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-1073741825,
                1073741825);
        Sequence<Integer> seq2 = this.createFromArgs();
        Sequence<Integer> expectedSeq2 = this.createFromArgs(0);
