...
public abstract class StatementTest {
     ...
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_EMPTY = "data/statement-empty.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_ONE_INSTRUCTION = "data/statement-one-instruction.bl";
    ...
    // additional test cases to thoroughly test StatementKernel

    // kind
    /**
     * Test kind of an IF_ELSE statement.
     */
    @Test
    public final void testKindIF_ELSE() {
        /*
         * Setup
         */
        final int Pos = 2;
        Statement blockTest = this.createFromFileTest(FILE_NAME_1);
        Statement blockRef = this.createFromFileRef(FILE_NAME_1);
        Statement sTest = blockTest.removeFromBlock(Pos);
        Statement sRef = blockRef.removeFromBlock(Pos);
        Kind kRef = sRef.kind();
    ...
    /**
     * Test addToBlock at the front of the block.
     */
    @Test
    ...
    /**
     * Test addToBlock at the end of the block.
     */
    @Test
    ...
    /**
     * Test removeFromBlock in the middle of block leaving a non-empty block
     * behind.
     */
    @Test
    ...
    /**
     * Test removeFromBlock at the end of block leaving a non-empty block
     * behind.
     */
    @Test
    ...
    public final void testRemoveFromBlockLeavingEmpty() {
         ...
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_ONE_INSTRUCTION);
        Statement sRef = this.createFromFileRef(FILE_NAME_ONE_INSTRUCTION);
        Statement nestedRef = sRef.removeFromBlock(0);
    ...
    /**
     * Test lengthOfBlock with a block of length of zero.
     */
    @Test
