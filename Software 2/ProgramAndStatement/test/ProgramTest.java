...
public abstract class ProgramTest {
    ...
    private static final String FILE_NAME_ADDED_EMPTY = "data/program-empty.bl";

    private static final String FILE_NAME_ADDED_CONTEST = "data/program-bugs-contest.bl";
    ...
    public final void testNewBodyEmpty() {
         ...
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_ADDED_EMPTY);
        Program pRef = this.createFromFileTest(FILE_NAME_ADDED_EMPTY);
        Statement bRef = pRef.newBody();
        /*
         * The call
         */
    ...
    public final void testReplaceNameEmpty() {
         ...
         */
        Program pTest = this.createFromFileTest(FILE_NAME_ADDED_EMPTY);
        Program pRef = this.createFromFileRef(FILE_NAME_ADDED_EMPTY);
        String newName = "Replacement";
        String nameRef = pRef.replaceName(newName);
     ...
     */
    @Test
    public final void testReplaceNameNested() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_ADDED_CONTEST);
        Program pRef = this.createFromFileRef(FILE_NAME_ADDED_CONTEST);
        String newName = "Replacement";
        String nameRef = pRef.replaceName(newName);
     ...
     */
    @Test
    public final void testNewContextNested() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_ADDED_CONTEST);
     ...
     */
    @Test
    public final void testNewBodyNested() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_ADDED_CONTEST);
    ...
    /**
     * Test replaceBody Nested
     */
    @Test
    public final void testReplaceBodyNested() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_ADDED_CONTEST);
