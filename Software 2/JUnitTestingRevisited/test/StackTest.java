...
public abstract class StackTest {
    ...
    @Test
    public final void myTestPushEmpty() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest();
    ...
    @Test
    public final void myTestPush1Element() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("blue");
        Stack<String> sExpected = this.createFromArgsRef("red", "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void myTestPush3Element() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("blue", "green", "alpha");
    ...
    @Test
    public final void myTestPush4Element() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("blue", "green", "alpha",
    ...
    @Test
    public final void myTestPop1Element() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red");
         ...
         * Assert that values of variables match expectations
         */
        assertEquals(xPected, x);
        assertEquals(sExpected, s);
    }

    @Test
    public final void myTestPop3Elements() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void myTestPop4Elements() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red", "blue", "green",
    ...
    @Test
    public final void myTestLengthEmpty() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest();
    ...
    @Test
    public final void myTestLength1Element() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red");
    ...
    @Test
    public final void myTestLength3Element() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red", "green", "blue");
        Stack<String> sExpected = this.createFromArgsRef("red", "green",
                "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void myTestLength4Element() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red", "green", "blue",
                "alpha");
        Stack<String> sExpected = this.createFromArgsRef("red", "green", "blue",
                "alpha");
        /*
         * Call method under test
         */
