 ...
 *
 */
public class CountPrimitiveCallsTest {
    ...
    @Test
    public void test2countInstruction() {
        Statement s1 = this.createFromArgs("data/test1.bl", true);
        Statement s2 = this.createFromArgs("data/test1.bl", true);
        int count = CountPrimitiveCalls.countOfInstructionCalls(s1, "WHILE");
        assertEquals(5, count);
        assertEquals(s2, s1);
    }

    @Test
    public void test3simplify() {
        Statement s1 = this.createFromArgs("data/test1.bl", true);
        Statement s2 = this.createFromArgs("data/test1.bl", true);
