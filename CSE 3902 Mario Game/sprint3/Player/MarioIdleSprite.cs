...
namespace MarioGame
{
    public class MarioIdleSprite : IMarioSprite
    {
        ...
        public MarioIdleSprite(Texture2D texture, int columns, int startFrame, Boolean leftFacing, MarioStateMachine.MarioSize size)
        {
            Shade = Color.White;
            Texture = texture;
            Columns = columns;
